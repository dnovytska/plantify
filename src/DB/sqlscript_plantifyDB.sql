...
CREATE TABLE IF NOT EXISTS plant_types (
  ...
  name TEXT NOT NULL,plant_types_id INTEGER,
  watering_id INTEGER,
  sunlight_id INTEGER,
  growth_rate_id INTEGER,
  care_level_id INTEGER,
  FOREIGN KEY (watering_id) REFERENCES watering_levels(idwatering_levels),
  FOREIGN KEY (sunlight_id) REFERENCES sunlight_levels(idsunlight_levels),
  FOREIGN KEY (growth_rate_id) REFERENCES growth_rates(idgrowth_rates),
  FOREIGN KEY (care_level_id) REFERENCES care_levels(idcare_levels)
);
...
CREATE TABLE IF NOT EXISTS plants (
  ...
  FOREIGN KEY (plant_type_id) REFERENCES plant_types(plant_types)
);
